...
\begin{figure*}
\centering
\subfloat[Relative decrement solution.\label{fig:toy_prob_soln_a}]{\includegraphics[width=0.33\textwidth]{figs/acc_toy_problem}} 
\subfloat[Relative error solution.\label{fig:toy_prob_soln_b}]{\includegraphics[width=0.33\textwidth]{figs/acc_toy_problem_relerr}} 
\subfloat[The performance metric $\pmet$. Color regions correspond to Figure~\ref{fig:scp_updates}.\label{fig:toy_prob_soln_c}]{\includegraphics[width=0.33\textwidth]{figs/acc_toy_problem_rho}}
